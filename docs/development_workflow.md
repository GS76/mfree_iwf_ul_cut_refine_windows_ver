...
Legacy Unix helper hook installers may remain in the repo for historical reasons, but active run/test workflow for this branch is Windows PowerShell from repository root.
