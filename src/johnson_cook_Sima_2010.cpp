...
void johnson_cook_Sima_2010::set_eps_init(double eps_init) { m_eps_pl_equiv_init = eps_init; }

void johnson_cook_Sima_2010::set_temp(double t) { m_t = t; }
...
double johnson_cook_Sima_2010::evaluate_flow_rule(double delta_lambda, double norm_Strial, double eps_pl_equiv_init, double T, double mu,
...
double johnson_cook_Sima_2010::sigma_yield(double eps_pl, double eps_dot_pl) const { return sigma_yield(eps_pl, eps_dot_pl, m_t); }
...
double johnson_cook_Sima_2010::f(double delta_lambda) { return this->operator()(delta_lambda); }
