...
void body::set_tool(tool *tool) { m_tool = tool; }

thermal *body::get_thermal() { return m_thermal; }
...
glm::dvec2 body::speed_tool() { return m_tool->get_vel(); }

glm::dvec2 body::edge_tool() { return m_tool->get_edge_coord(); }
