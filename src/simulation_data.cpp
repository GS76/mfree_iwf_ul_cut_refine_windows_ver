...
double thermal_constants::cp(double T) const { return m_cp.get(T); }

double thermal_constants::Taylor_Quinney() const { return m_Taylor_Quinney; }

double thermal_constants::k(double T) const { return m_k.get(T); }
...
double physical_constants::nu(double T) const { return m_nu.get(T); }

double physical_constants::E(double T) const { return m_E.get(T); }

double physical_constants::G(double T) const { return E(T) / (2. * (1. + nu(T))); }
...
double physical_constants::mu_lame(double T) const { return E(T) / (2.0 + 2.0 * nu(T)); }

double physical_constants::lambda_lame(double T) const { return nu(T) * E(T) / ((1.0 + nu(T)) * (1.0 - 2.0 * nu(T))); }

double physical_constants::rho0(double T) const { return m_rho0.get(T); }

double physical_constants::alpha(double T) const { return m_alpha.get(T); }

double physical_constants::c0(double T) const { return sqrt(K(T) / rho0(T)); }
