...
#pragma omp critical
		{
			std::cout << "  Thread " << std::setw(2) << thread_id << " is running on Core " << std::setw(2) << core_ids[thread_id]
					  << std::endl;
		}
	}
...
int main(int argc, char *argv[]) {
	...
	for (int t : test_threads) {
		...
		std::cout << std::setw(8) << t << " | " << std::setw(10) << std::fixed << std::setprecision(4) << duration << " | " << std::setw(7)
				  << std::setprecision(2) << speedup << "x | " << std::setw(7) << efficiency << "% | " << std::setw(7) << imbalance << "%"
				  << std::endl;
	}
	...
	for (int t : test_threads) {
		...
		std::cout << std::setw(8) << t << " | " << std::setw(10) << std::fixed << std::setprecision(4) << duration << " | " << std::setw(7)
				  << std::setprecision(2) << speedup << "x | " << std::setw(10) << bandwidth << std::endl;
	}
